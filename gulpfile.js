...
function startwatch() {
	...
	watch('app/src/**/*.pug', pugging);
}
 
// Экспортируем функцию browsersync() как таск browsersync. Значение после знака = это имеющаяся функция.
exports.browsersync = browsersync;

exports.pugging = pugging;
...
exports.build = series(cleandist, pugging, styles, scripts, images, buildcopy);
 
// Экспортируем дефолтный таск с нужным набором функций
exports.default = parallel(pugging, styles, scripts, images, browsersync, startwatch);